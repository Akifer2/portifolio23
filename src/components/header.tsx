...
export default function Header() {
    ...
    return (
        <>
            <header
                className={`bg-gradient-to-b from-[#2b2b2b96] to-transparent w-full flex justify-between p-6 fixed z-[100] transition-transform duration-300 ${isVisible ? "translate-y-0" : "-translate-y-full"}`}
            >
                {/* Desktop Navigation */}
